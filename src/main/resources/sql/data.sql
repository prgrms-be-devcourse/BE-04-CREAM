...
-- (1, 1, 220) ,(2, 1, 230), (3, 1, 240), (4, 1, 250), (5, 1, 260), (6, 1, 270), (7, 1, 280),
...
INSERT INTO PURCHASE_BIDDINGS(ID, PURCHASE_BIDDER_ID, PRODUCT_ID, PRICE, STATUS, START_DATE, DUE_DATE) VALUES
(1, 1, 1, 180000, 'LIVE', NOW(), TIMESTAMPADD(DAY, 7, NOW())),
(2, 2, 1, 150000, 'LIVE', NOW(), TIMESTAMPADD(DAY, 7, NOW()));

INSERT INTO SELL_BIDDINGS(ID, SELL_BIDDER_ID, PRODUCT_ID, PRICE, STATUS, START_DATE, DUE_DATE) VALUES
...
(4, 3, 8, 120000, 'LIVE', NOW(), TIMESTAMPADD(DAY, 7, NOW())),
(5, 3, 8, 130000, 'LIVE', NOW(), TIMESTAMPADD(DAY, 7, NOW()));
