...
INSERT INTO INVENTORIES(ID, USER_ID, PRODUCT_ID, PRICE, PRODUCT_QUALITY, STATUS, START_DATE, ZIPCODE, ADDRESS, ADDRESS_DETAIL) VALUES
(1, 2, 1, 50000, 'COMPLETE', 'EXPIRED', NOW(), '12345', 'SEOUL', 'detail'),
(2, 2, 1, 55000, 'COMPLETE', 'LIVE', NOW(), '12345', 'SEOUL', 'detail'),
(3, 2, 1, 55000, 'COMPLETE', 'LIVE', TIMESTAMPADD (DAY, -7, NOW()), '12345', 'SEOUL', 'detail');
